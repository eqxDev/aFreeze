...
public enum Lang {
    ...
    FREEZE_ALL("FREEZE_ALL", "&aYou have frozen all the players on the server."),
    UNFREEZE_ALL_BROADCAST("UNFREEZE_ALL_BROADCAST", "&7[&caFreeze&7] &cThe whole server has been unfrozen."),
    UNFREEZE_ALL("UNFREEZE_ALL", "&aYou have unfrozen all the players on the server."),
    ...
    CHATROOM_FORMAT("CHATROOM_FORMAT", "&b%name%: %msg%"),
